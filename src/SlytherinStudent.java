public class SlytherinStudent extends  HogwartsStudent {
    ...
    public void compareHogwarts (SlytherinStudent slytherinStudent ) {
        ...
        if (ability1 > ability2) {
            System.out.println("Слизернец " + getName() + " лучше чем Слизернец " +  slytherinStudent.getName() + " : " + ability1 + " VS " + ability2);
        } else if (ability1 < ability2) {
            System.out.println("Слизернец " + getName() + " лучше чем Слизернец " +  slytherinStudent.getName() + " : " + ability1 + " VS " + ability2);
        } else {
            System.out.println("Слизернец " + getName() + " такой же,как и Слизернец " +  slytherinStudent.getName() + " : " + ability1 + " VS " + ability2);
